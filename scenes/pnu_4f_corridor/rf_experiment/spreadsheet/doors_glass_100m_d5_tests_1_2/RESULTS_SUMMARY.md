...
회절+산란 Raw Sionna의 6개 Test 위치 MAE는 **14.90 dB**, 네 Calibration 위치를 모두 쓴 전역 편향 보정 후에는 **7.48 dB**다. Test 3은 철문 상태가 달라 제외했다.

## 최종 비교

| 결과 | MAE (dB) | RMSE (dB) | Pearson r |
|---|---:|---:|---:|
| 단순 Sionna RT: 회절+산란 | 14.90 | 15.54 | 0.970 |
| Calibration 보정: all-4 global bias | 7.48 | 8.58 | 0.970 |

- 주 평가는 Test 1·2의 같은 위치를 먼저 평균한 **6개 독립 위치** 기준이다.
- 보정 MAE의 위치 bootstrap 95% 구간은 **3.91–10.64 dB**다.
- 12개 반복 관측을 그대로 합친 MAE는 Raw **14.90 dB**, 보정 **8.35 dB**다.

## Held-out Test 실제값 vs 예측값

| 위치 | 실제 평균 (dBm) | Raw Sionna (dBm) | 보정 Sionna (dBm) | 보정 절대오차 (dB) |
|---|---:|---:|---:|---:|
| test-01 | -41.50 | -29.77 | -37.30 | 4.20 |
| test-02 | -38.00 | -30.80 | -38.33 | 0.33 |
| test-03 | -49.00 | -32.87 | -40.41 | 8.59 |
| test-04 | -58.00 | -42.27 | -49.81 | 8.19 |
| test-05 | -66.50 | -45.52 | -53.05 | 13.45 |
| test-06 | -64.25 | -46.62 | -54.16 | 10.09 |
...
| doors_glass_diffraction_scattering_authored_100m_d5 | raw_sionna | 14.90 | 15.54 |
| doors_glass_diffraction_scattering_authored_100m_d5 | global_bias_all4 | 7.48 | 8.58 |
