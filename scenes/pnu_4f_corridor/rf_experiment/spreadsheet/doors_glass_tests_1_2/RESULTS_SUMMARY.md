...
회절+산란 Raw Sionna의 6개 Test 위치 MAE는 **14.04 dB**, 네 Calibration 위치를 모두 쓴 전역 편향 보정 후에는 **6.76 dB**다. Test 3은 철문 상태가 달라 제외했다.

## 최종 비교

| 결과 | MAE (dB) | RMSE (dB) | Pearson r |
|---|---:|---:|---:|
| 단순 Sionna RT: 회절+산란 | 14.04 | 14.55 | 0.967 |
| Calibration 보정: all-4 global bias | 6.76 | 7.69 | 0.967 |

- 주 평가는 Test 1·2의 같은 위치를 먼저 평균한 **6개 독립 위치** 기준이다.
- 보정 MAE의 위치 bootstrap 95% 구간은 **3.54–9.44 dB**다.
- 12개 반복 관측을 그대로 합친 MAE는 Raw **14.04 dB**, 보정 **7.64 dB**다.

## Held-out Test 실제값 vs 예측값

| 위치 | 실제 평균 (dBm) | Raw Sionna (dBm) | 보정 Sionna (dBm) | 보정 절대오차 (dB) |
|---|---:|---:|---:|---:|
| test-01 | -41.50 | -29.95 | -37.31 | 4.19 |
| test-02 | -38.00 | -30.90 | -38.27 | 0.27 |
| test-03 | -49.00 | -33.01 | -40.38 | 8.62 |
| test-04 | -58.00 | -42.52 | -49.89 | 8.11 |
| test-05 | -66.50 | -47.30 | -54.66 | 11.84 |
| test-06 | -64.25 | -49.36 | -56.73 | 7.52 |
...
| doors_glass_diffraction_scattering_authored | raw_sionna | 14.04 | 14.55 |
| doors_glass_diffraction_scattering_authored | global_bias_all4 | 6.76 | 7.69 |
